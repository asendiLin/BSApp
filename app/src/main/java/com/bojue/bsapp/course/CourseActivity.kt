...
class CourseActivity : BaseActivity(), ICurrentWeek, AdapterView.OnItemSelectedListener,View.OnClickListener {
     ...
     * 课程页面的button引用，6行7列
     */
    private val lessons = arrayOf(intArrayOf(R.id.lesson17, R.id.lesson11, R.id.lesson12, R.id.lesson13, R.id.lesson14, R.id.lesson15, R.id.lesson16), intArrayOf(R.id.lesson27, R.id.lesson21, R.id.lesson22, R.id.lesson23, R.id.lesson24, R.id.lesson25, R.id.lesson26),
